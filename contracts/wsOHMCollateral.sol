...
import "../other-examples/wsOHM.sol";

/**
 * @title wsOHMCollateral
 ...
 */
contract wsOHMCollateral is Collateral {
    ...
    function refresh() external virtual override {
        ...
        OHMToken(address(erc20)).exchangeRateCurrent();
    ...
    function refPerTok() public view override returns (uint192) {
        uint256 rate = OHMToken(address(erc20)).exchangeRateStored();
